package com.af.clientmanager.control.commands.clientCommands
{
	...
	public class DeleteClientLinkCommand implements Command, IResponder
	{
		...
		public function execute( event : CairngormEvent ) : void
		{
			...
			var deleteClientLinkEvent : DeleteClientLinkEvent = DeleteClientLinkEvent( event );  
			delegate.deleteClientLink( deleteClientLinkEvent.clientLinkVO );      
		}
